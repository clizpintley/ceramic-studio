  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Caveat:wght@500;600&family=Poiret+One&family=Playfair+Display:wght@700;900&family=Lora:wght@400;600&display=swap' }
      ]
    }
  },
  runtimeConfig: {
