...
const normalize = (content) => {
  ...
  return {
    ...
    contact: {
      ...
      showEmail: content?.contact?.showEmail !== false,
      ...
      showInstagram: content?.contact?.showInstagram !== false,
      ...
      showEtsy: content?.contact?.showEtsy !== false,
      etsyLabel: String(content?.contact?.etsyLabel ?? defaultContent.contact.etsyLabel).trim(),
      etsyName: String(content?.contact?.etsyName ?? defaultContent.contact.etsyName).trim(),
      etsyUrl: String(content?.contact?.etsyUrl ?? defaultContent.contact.etsyUrl).trim(),
      showFacebook: Boolean(content?.contact?.showFacebook),
      facebookLabel: String(content?.contact?.facebookLabel ?? defaultContent.contact.facebookLabel).trim(),
      facebookHandle: String(content?.contact?.facebookHandle ?? defaultContent.contact.facebookHandle).trim(),
      facebookUrl: String(content?.contact?.facebookUrl ?? '').trim(),
